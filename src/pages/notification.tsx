      ...
      <div className="mx-auto space-y-5">
        ...
        <div className="max-w-4xl space-y-5 text-center">
          ...
          <p>
            ...
            notification regarding the status of your application. Please allow
            up to 3 business days for our team to process your application.
          </p>
          <p>
        ...
        <Link href="/" className="">
          <button type="button" className="mx-auto mt-5 w-max bg-secondary">
            <svg
