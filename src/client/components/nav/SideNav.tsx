const SideNav = () => {
  return (
    <section className="relative flex h-screen min-h-full items-start  overflow-y-hidden border bg-gray-50 dark:border-zinc-900 dark:bg-zinc-700">
      <nav
        id="sidenav-5"
      ...
      <button
        className="mt-10  rounded bg-blue-600 px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg"
