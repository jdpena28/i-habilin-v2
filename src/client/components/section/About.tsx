          ...
          <p className="space m-10  w-4/5 space-y-0 pb-10 font-neuemachina ">
            ...
            <blockquote>
              <p className="mt-10 italic">
                ...
                The proposed project focus to modernize the current state of
                food ordering process in some local food courts to make it
                something more engaging and convenient for both clients and
                entrepreneurs.
              </p>
            </blockquote>
          </p>
